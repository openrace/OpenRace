...
### /OpenRace/settings/audio_output/[language]
Language chosen for the TTS enginge.
### /OpenRace/provide/
...
The strips with attached voltage board publish the battery voltage here. This value will be forwarded by the LED
controller.
